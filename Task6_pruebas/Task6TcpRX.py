...
class Task6TcpRX(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Task6TcpRX")
        ...
        self.network_tcp_source_0 = network.tcp_source.tcp_source(itemsize=gr.sizeof_gr_complex*1,addr='127.0.0.1',port=6000,server=False)
        self.epy_block_1 = epy_block_1.blk(M_qam=M_qam)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/popo/Escritorio/Task6_pruebas/task6_tcp_rx_texto.txt', False)
        ...
        self.connect((self.network_tcp_source_0, 0), (self.epy_block_1, 0))
        self.connect((self.network_tcp_source_0, 0), (self.qtgui_const_sink_x_1, 0))
        self.connect((self.network_tcp_source_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.network_tcp_source_0, 0), (self.qtgui_time_sink_x_0, 0))
    ...
    def set_M_qam(self, M_qam):
        self.M_qam = M_qam
        self._M_qam_callback(self.M_qam)
        self.epy_block_1.M_qam = self.M_qam




def main(top_block_cls=Task6TcpRX, options=None):
