...
class file_atsc_rx(gr.top_block):
    ...
    def __init__(self):
        ...
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_cc(50000)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/popo/Escritorio/Task4_ATSC/task4_atsc_mod.cfile', False, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/popo/Escritorio/Task4_ATSC/task4_video_rx.ts', False)
        ...
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.dtv_atsc_rx_0, 0))
