...
class file_atsc_tx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/popo/Escritorio/Task4_ATSC/task4_video_tx.ts', False, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/popo/Escritorio/Task4_ATSC/task4_atsc_mod.cfile', False)
