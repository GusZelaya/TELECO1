...
import ofdm_loopback_example_epy_block_0 as epy_block_0  # embedded python block
import sip
...
class ofdm_loopback_example(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.packet_len = packet_len = 188
        self.noise_voltage = noise_voltage = 0.0
        ...
        self._noise_voltage_range = qtgui.Range(0, 10, .01, 0.0, 200)
        ...
        self.network_udp_sink_0 = network.udp_sink(gr.sizeof_char, 1, '127.0.0.1', 5000, 0, 188, False)
        self.network_socket_pdu_0 = network.socket_pdu('UDP_SERVER', '0.0.0.0', '4999', 2048, False)
        self.epy_block_0 = epy_block_0.blk()
        self.digital_ofdm_tx_0 = digital.ofdm_tx(
            fft_len=fft_len,
            cp_len=cp_len,
            packet_length_tag_key='packet_len',
            occupied_carriers=(tuple(list(range(-26,-21)) + list(range(-20,-7)) + list(range(-6,0)) + list(range(1,7)) + list(range(8,21)) + list(range(22,27))),),
        ...
        self.digital_ofdm_tx_0.set_max_output_buffer(262144)
        ...
        self.digital_ofdm_rx_0.set_max_output_buffer(262144)
        ...
        # Connections
        ##################################################
        self.msg_connect((self.epy_block_0, 'pdus'), (self.pdu_pdu_to_tagged_stream_0, 'pdus'))
        self.msg_connect((self.network_socket_pdu_0, 'pdus'), (self.epy_block_0, 'pdus'))
        ...
        self.connect((self.pdu_pdu_to_tagged_stream_0, 0), (self.digital_ofdm_tx_0, 0))
